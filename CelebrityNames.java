...
/**
 * Sorts a list of names by birthdate
 * 
 * @author Roger Jaffe, Bryan Hayes
 * @version 2015-01-19
 */
public class CelebrityNames
{
    ...
    { 
        ...
        { 
            ...
            reversedName[j] = birthday + " " + lastName + ", " + firstName + " " + middleName + "-- " + birthday;
        }
        
        Arrays.sort(reversedName);
        String sortedName[] = new String[maxIndx + 1];
        ...
        { 
            ...
            String firstName = sc.next( );
            String middleName = sc.next( );
            sortedName[j] = lastName + " " + firstName + " " + middleName + birthday;
        }
        ...
        for (int j =0; j <= maxIndx; j++)
        { 
            System.out.println(sortedName[j]);
            output.println(sortedName[j]);
        } 
        output.close();
        fw.close();
    }
